...
int32_t plotMinX, plotMaxX, plotMinY, plotMaxY;
...
void ST7735_XYplotInit(char *title, int32_t minX, int32_t maxX, int32_t minY, int32_t maxY, uint16_t color){
	...
	ST7735_FillRect(0,32,128,128, color);
	plotMinX = minX;
	plotMaxX = maxX;
	plotMinY = minY;
	plotMaxY = maxY;
...
void ST7735_XYplot(uint32_t num, int32_t bufX[], int32_t bufY[], uint16_t color){
	...
	for(uint32_t a=0; a<num; a++){
		...
		i = (127*(bufX[a]-plotMinX))/(plotMaxX-plotMinX);
		// y=MaxY maps to j=32
		// y=MinY maps to j=159 
		j = 32+(127*(plotMaxY - bufY[a]))/(plotMaxY-plotMinY);
